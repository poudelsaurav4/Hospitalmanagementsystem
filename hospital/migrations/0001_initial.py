    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('roles', models.CharField(choices=[('Assitant', 'Assistant'), ('Doctor', 'Doctor'), ('Receptionist', 'Receptionist'), ('Patient', 'Patient')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doctor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='doctor_appointments', to='hospital.doctor')),
            ],
        ),
        migrations.CreateModel(
            name='Patient',
